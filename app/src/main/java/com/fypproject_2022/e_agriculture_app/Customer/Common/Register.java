...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfieImage=findViewById(R.id.imageView);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                customer.setPhone(phoneNoET.getText().toString());
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    user.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void unused) {
                                                            Utilities.createAlertDialog(Register.this, "Notice", "A verification email has been sent to " + emailET.getText().toString());
                                                            loadingBar.dismiss();
...
//                                                            finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data !=null && data.getData() !=null)
        {
            ...
            Picasso.get().load(mImageUri).into(mProfieImage);
        }
    }
